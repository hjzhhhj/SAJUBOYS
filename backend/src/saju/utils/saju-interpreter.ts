export class SajuInterpreter {
  ...
  static PERSONALITY_BY_DAY_STEM = {
    갑: {
      basic:
        '리더십이 강하고 정직하며 곧은 성품을 가지고 있습니다. 새로운 시작을 좋아하고 개척정신이 강합니다.',
      strength: '추진력, 결단력, 정의감, 진취성',
      weakness: '고집, 융통성 부족, 독선적 경향',
    },
    을: {
      basic:
        '부드럽고 유연하며 적응력이 뛰어납니다. 협조적이고 타인을 배려하는 성품입니다.',
    ...
    정: {
      basic:
        '섬세하고 예민하며 감수성이 풍부합니다. 예술적 재능과 직관력이 뛰어납니다.',
      strength: '직관력, 예술성, 섬세함, 배려심',
      weakness: '예민함, 변덕, 의심 많음',
    },
    무: {
      basic:
        '신뢰감을 주고 포용력이 있으며 중심을 잘 잡습니다. 책임감이 강하고 실용적입니다.',
      strength: '신뢰성, 포용력, 균형감, 실용성',
      weakness: '완고함, 변화 거부, 보수적',
    },
    기: {
      basic:
        '꼼꼼하고 세심하며 계획적입니다. 분석력이 뛰어나고 완벽을 추구합니다.',
    ...
    신: {
      basic:
        '예리하고 민첩하며 변화를 추구합니다. 개혁적이고 진보적인 사고를 합니다.',
    ...
    계: {
      basic:
        '섬세하고 직관적이며 창의적입니다. 상상력이 풍부하고 감성적입니다.',
  ...
  static interpretFiveElements(elements: { [key: string]: number }): string {
    ...
    if (dominant.percentage > 40) {
      ...
      switch (dominant.element) {
        case '목':
          interpretation +=
            '성장과 발전의 에너지가 풍부합니다. 진취적이고 적극적인 성향이 강합니다.\n';
          break;
        case '화':
          interpretation +=
            '열정과 활력이 넘칩니다. 밝고 긍정적이며 표현력이 풍부합니다.\n';
          break;
        case '토':
          interpretation +=
            '안정적이고 신뢰할 수 있습니다. 중재 능력이 뛰어나고 포용력이 있습니다.\n';
          break;
        case '금':
          interpretation +=
            '결단력과 추진력이 강합니다. 원칙적이고 정의로운 성향입니다.\n';
          break;
        case '수':
          interpretation +=
            '지혜롭고 유연합니다. 적응력이 뛰어나고 사고가 깊습니다.\n';
          break;
      }
    }
