      ...
      <ContentWrapper>
        ...
        {resultData.saeun && (
          <ResultCard>
            ...
            <Description>
              {new Date().getFullYear()}년 세운: {resultData.saeun.heaven}
          ...
          <>
            {resultData.interpretation.advancedAnalysis.zodiac && (
              <ZodiacCard>
                ...
                <p style={{ lineHeight: "2", fontSize: "1.1rem", marginBottom: "1.5rem" }}>
                  {
                    resultData.interpretation.advancedAnalysis.zodiac
                      .personality
                  }
                </p>
                <div style={{ borderTop: "1px solid rgba(255,255,255,0.3)", paddingTop: "1.5rem", marginTop: "1.5rem" }}>
                  <h4 style={{ fontSize: "1.2rem", marginBottom: "1rem", fontWeight: "600" }}>
                    {resultData.interpretation.advancedAnalysis.zodiac.animal}띠 상세 분석
                  </h4>
                  <div style={{ textAlign: "left", fontSize: "1rem", lineHeight: "1.8" }}>
                    <div style={{ marginBottom: "1rem" }}>
                      <strong>성격적 특징:</strong> {getZodiacDetails(resultData.interpretation.advancedAnalysis.zodiac.animal).personality}
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <strong>장점:</strong> {getZodiacDetails(resultData.interpretation.advancedAnalysis.zodiac.animal).strengths}
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <strong>주의할 점:</strong> {getZodiacDetails(resultData.interpretation.advancedAnalysis.zodiac.animal).weaknesses}
                    </div>
                    <div>
                      <strong>행운의 방향:</strong> {getZodiacDetails(resultData.interpretation.advancedAnalysis.zodiac.animal).lucky}
                    </div>
                  </div>
                </div>
              </ZodiacCard>
...
function getZodiacDetails(animal) {
  const zodiacDetails = {
    쥐: {
      personality: "지혜롭고 재치가 뛰어나며, 빠른 판단력과 적응력을 가지고 있습니다. 사교성이 좋고 리더십이 있어 어떤 상황에서도 중심 역할을 합니다.",
      strengths: "영리하고 근면하며, 세심한 관찰력과 계획성을 갖추고 있어 어떤 환경에서도 성공할 수 있는 능력이 있습니다. 재물 운용 능력이 뛰어납니다.",
      weaknesses: "때로는 지나치게 신중하거나 소심할 수 있으니, 과감한 결단이 필요한 순간을 놓치지 않도록 주의해야 합니다.",
      lucky: "북쪽이 길하며, 파란색과 검은색이 행운을 가져다 줍니다. 숫자 1과 4가 행운의 숫자입니다."
    },
    소: {
      personality: "성실하고 꾸준하며, 강한 인내심과 책임감을 가지고 있습니다. 신중하고 보수적이지만 한번 결정하면 끝까지 밀고 나가는 추진력이 있습니다.",
      strengths: "믿음직스럽고 안정적이며, 꾸준한 노력으로 큰 성취를 이루는 타입입니다. 리더십과 조직력이 뛰어납니다.",
      weaknesses: "고집이 세고 융통성이 부족할 수 있으니, 다른 사람의 의견도 경청하는 자세가 필요합니다.",
      lucky: "북동쪽이 길하며, 노란색과 갈색이 행운을 가져다 줍니다. 숫자 1과 9가 행운의 숫자입니다."
    },
    호랑이: {
      personality: "용감하고 대담하며, 강한 리더십과 카리스마를 가지고 있습니다. 정의감이 강하고 독립적이며 모험을 즐깁니다.",
      strengths: "추진력이 강하고 결단력이 있으며, 어려운 상황에서도 굴복하지 않는 강인한 정신력을 가지고 있습니다.",
      weaknesses: "성급하고 충동적일 수 있으니, 중요한 결정은 신중하게 내리는 것이 좋습니다.",
      lucky: "동쪽이 길하며, 파란색과 회색이 행운을 가져다 줍니다. 숫자 3과 8이 행운의 숫자입니다."
    },
    토끼: {
      personality: "온화하고 섬세하며, 예술적 감각과 직관력이 뛰어납니다. 평화를 사랑하고 조화를 중시합니다.",
      strengths: "외교적이고 재치가 있으며, 타인과의 관계를 잘 유지합니다. 미적 감각이 뛰어나고 창의적입니다.",
      weaknesses: "우유부단하고 소극적일 수 있으니, 자신감을 가지고 적극적으로 행동하는 것이 중요합니다.",
      lucky: "동쪽이 길하며, 분홍색과 보라색이 행운을 가져다 줍니다. 숫자 3과 4가 행운의 숫자입니다."
    },
    용: {
      personality: "카리스마가 넘치고 야망이 크며, 타고난 리더십을 가지고 있습니다. 자신감이 넘치고 열정적입니다.",
      strengths: "창의적이고 혁신적이며, 큰 그림을 그리는 능력이 뛰어납니다. 목표를 향한 추진력이 강합니다.",
      weaknesses: "자만심이 강하고 독선적일 수 있으니, 겸손한 자세를 유지하는 것이 중요합니다.",
      lucky: "동남쪽이 길하며, 금색과 은색이 행운을 가져다 줍니다. 숫자 1과 6이 행운의 숫자입니다."
    },
    뱀: {
      personality: "지혜롭고 신비로우며, 깊은 통찰력과 직관력을 가지고 있습니다. 침착하고 차분한 성격입니다.",
      strengths: "분석력이 뛰어나고 전략적 사고를 잘합니다. 목표를 위해 꾸준히 노력하는 인내심이 있습니다.",
      weaknesses: "의심이 많고 질투심이 강할 수 있으니, 타인을 신뢰하는 법을 배우는 것이 좋습니다.",
      lucky: "남쪽이 길하며, 빨간색과 노란색이 행운을 가져다 줍니다. 숫자 2와 7이 행운의 숫자입니다."
    },
    말: {
      personality: "자유분방하고 활동적이며, 모험심과 독립심이 강합니다. 사교적이고 낙천적입니다.",
      strengths: "열정적이고 추진력이 있으며, 빠른 판단력과 행동력을 가지고 있습니다. 커뮤니케이션 능력이 뛰어납니다.",
      weaknesses: "인내심이 부족하고 변덕스러울 수 있으니, 한 가지 일에 집중하는 노력이 필요합니다.",
      lucky: "남쪽이 길하며, 보라색과 갈색이 행운을 가져다 줍니다. 숫자 2와 3이 행운의 숫자입니다."
    },
    양: {
      personality: "온순하고 예술적이며, 창의력과 상상력이 풍부합니다. 타인을 배려하고 평화를 추구합니다.",
      strengths: "친절하고 관대하며, 예술적 재능이 뛰어납니다. 타인과의 조화를 잘 이룹니다.",
      weaknesses: "결단력이 부족하고 의존적일 수 있으니, 독립적인 판단력을 기르는 것이 중요합니다.",
      lucky: "남서쪽이 길하며, 녹색과 빨간색이 행운을 가져다 줍니다. 숫자 3과 9가 행운의 숫자입니다."
    },
    원숭이: {
      personality: "영리하고 재치가 있으며, 호기심이 많고 다재다능합니다. 유머 감각이 뛰어나고 사교적입니다.",
      strengths: "문제 해결 능력이 뛰어나고 적응력이 강합니다. 창의적이고 혁신적인 아이디어를 잘 냅니다.",
      weaknesses: "경솔하고 참을성이 부족할 수 있으니, 신중함과 인내심을 기르는 것이 필요합니다.",
      lucky: "서쪽이 길하며, 흰색과 금색이 행운을 가져다 줍니다. 숫자 4와 9가 행운의 숫자입니다."
    },
    닭: {
      personality: "부지런하고 성실하며, 완벽주의적 성향이 있습니다. 정직하고 용감하며 책임감이 강합니다.",
      strengths: "관찰력이 뛰어나고 세심합니다. 시간 관리를 잘하고 효율적으로 일을 처리합니다.",
      weaknesses: "비판적이고 까다로울 수 있으니, 타인의 단점보다 장점을 보는 연습이 필요합니다.",
      lucky: "서쪽이 길하며, 금색과 갈색이 행운을 가져다 줍니다. 숫자 5와 7이 행운의 숫자입니다."
    },
    개: {
      personality: "충성스럽고 정직하며, 정의감이 강합니다. 신뢰할 수 있고 책임감이 있습니다.",
      strengths: "성실하고 근면하며, 타인을 잘 돕습니다. 공정하고 원칙적입니다.",
      weaknesses: "보수적이고 걱정이 많을 수 있으니, 긍정적인 사고를 유지하는 것이 중요합니다.",
      lucky: "북서쪽이 길하며, 빨간색과 녹색이 행운을 가져다 줍니다. 숫자 3과 4가 행운의 숫자입니다."
    },
    돼지: {
      personality: "관대하고 낙천적이며, 정이 많고 순수합니다. 행복을 추구하고 즐거움을 아는 성격입니다.",
      strengths: "성실하고 책임감이 있으며, 타인에게 관대합니다. 재물운이 좋고 복이 많습니다.",
      weaknesses: "게으르고 낭비가 심할 수 있으니, 절제하는 습관을 기르는 것이 좋습니다.",
      lucky: "북쪽이 길하며, 노란색과 회색이 행운을 가져다 줍니다. 숫자 2와 5가 행운의 숫자입니다."
    }
  };
